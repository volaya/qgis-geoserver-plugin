...
class GeoServerExplorer(QDockWidget):
    ...
    def initGui(self):
        ...
        showToolbar = pluginSetting("ShowToolbar", "geoserverexplorer", typ=bool) or True
        ...
        showDescription = pluginSetting("ShowDescription", "geoserverexplorer", typ=bool) or True
